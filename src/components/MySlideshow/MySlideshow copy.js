      ...
      <SwiperSlide className="insurance-slide">
        <div className="card-main bg-white">
          <div className="insurance-box">
            ...
            <p className='insurance-box__content'>จ่ายทันที</p>
            </div>
      ...
      <SwiperSlide className="insurance-slide">
        <div className="card-main bg-white">
          <div  className="insurance-box">
            ...
            <div className='text'>
            <div className="title">อุบัติเหตุ</div>
            <p className='insurance-box__content'>เจ็บแค่ไหน </p>
            <p className='insurance-box__content'>ให้เราช่วยดูแล</p>
            </div>
     <div className='insurance-button'> < Buttons  onClick={() => window.location.href = '#/'} width="132px" label="เช็กเบี้ยประกัน" variant="primary"/></div>
      ...
      <SwiperSlide className="insurance-slide">
        <div className="card-main bg-white">
          <div className="insurance-box">
            ...
            <div className='text'>
            <div className="title">เดินทาง</div>
            <p className='insurance-box__content'>ปล่อยใจจอยได้ </p>
            <p className='insurance-box__content'>เพราะเราดูแลอยู่</p>
